(() => {
  ...
  mapWindow.addEventListener('click',e=>{if(e.target.closest('.marker,.marker-thumbnail,.region-hotspot,.province-place-dot,.province-shape,.map-3d-view,.map-3d-launcher'))return;if(state.selected){state.selected=null;history.replaceState(null,'',location.pathname+location.search);render();}});
